    ...
    return(
        <div className="w-full max-h-full flex flex-wrap items-start  overflow-y-scroll hide-scroll-track">
            ...
            <div className="w-[50%]  h-30 flex flex-col">
                ...
                <input value={price} onChange={(e)=>{setPrice(e.target.value)}} type="number" placeholder="Ex: 50000" className="border-4 border-accent rounded-[10px] h-12.5 p-2 m-2 focus:outline-white"/>
            </div>
            <div className="w-[50%]  h-30 flex flex-col">
            ...
            <div className="w-[25%]  h-30 flex flex-col">
                ...
                <select value={category} onChange={(e)=>{setCategory(e.target.value)}} className="border-4 border-accent rounded-[10px] h-12.5 p-2 m-2 focus:outline-white">
            ...
            <div className="w-[25%]  h-30 flex flex-col">
                ...
                <input value={model} onChange={(e)=>{setModel(e.target.value)}} placeholder="Ex: Inspiron 15" className="border-4 border-accent rounded-[10px] h-12.5 p-2 m-2 focus:outline-white"/>
            </div>
            <div className="w-[25%]  h-30 flex flex-col">
