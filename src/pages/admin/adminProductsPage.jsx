...
export default function AdminProductsPage() {
	...
	return (
		<div className="w-full h-full overflow-y-scroll ">
			...
			<table className="min-w-275 w-full text-sm relative">
			...
			<Link
				...
				className="text-white bg-accent w-12.5 h-12.5 flex justify-center items-center text-2xl rounded-[20px] hover:rounded-full fixed bottom-12 right-16"
			>
				<FaPlus />
			</Link>
		</div>
